...
public class CustomZombieHornItem extends Item {

    public CustomZombieHornItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient && user instanceof PlayerEntity player) {
            ...
            BossZombieEntity boss = ModEntities.BOSS_ZOMBIE.create(serverWorld);
