...
public class CustomCreeperHornItem extends Item {

    public CustomCreeperHornItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient && user instanceof PlayerEntity player) {
            ...
            BossCreeperEntity boss = ModEntities.BOSS_CREEPER.create(serverWorld);
